...
:: Download the 11.0x patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.07/misc/AdbeRdrUpd11007.msp|packages/adobereader/adberdrupd11007.msp
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.08/misc/AdbeRdrSecUpd11008.msp|packages/adobereader/adberdrsecupd11008.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11007.msp;%Z%\packages\adobereader\adberdrsecupd11008.msp\" REBOOT=ReallySuppress"
