...
:: Download the patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.13/misc/AdbeRdrUpd11013.msp|packages/adobereader/adberdrupd11013.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11013.msp\" REBOOT=ReallySuppress"
