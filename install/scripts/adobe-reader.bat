...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11021.msp;%Z%\packages\adobereader\adberdrupd11022_incr.msp\" REBOOT=ReallySuppress"
