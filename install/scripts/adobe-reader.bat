...
:: Download the 11.05 patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.05/misc/AdbeRdrSecUpd11005.msp|packages/adobereader/adberdrsecupd11005.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11004.msp;%Z%\packages\adobereader\adberdrsecupd11005.msp\" REBOOT=ReallySuppress"
