...
:: Download the patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.12/misc/AdbeRdrUpd11012.msp|packages/adobereader/adberdrupd11012.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11012.msp\" REBOOT=ReallySuppress"
