...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\acrordrDC1500720033_%WINLANG%.msi\" TRANSFORMS=acrordrdc1500720033_nor.mst REBOOT=ReallySuppress"
