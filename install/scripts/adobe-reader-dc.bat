:: OPTIONAL: Install Adobe Reader Document Cloud (DC) 2200320310
@Echo Off
...
:: URL|ALL|https://ardownload2.adobe.com/pub/adobe/reader/win/AcrobatDC/2200320310/AcroRdrDCUpd2200320310.msp|packages/adobereader/AcroRdrDCUpd2200320310.msp
...
todo.pl ".ignore-err 194 msiexec /qb /l* %SystemDrive%\netinst\logs\adobereaderdc.txt /i \"%Z%\packages\adobereader\acrordrdc1500720033_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\AcroRdrDCUpd2200320310.msp\" REBOOT=ReallySuppress"
