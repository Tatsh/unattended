...
:: Download the patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/AcrobatDC/1700920044/AcroRdrDCUpd1700920044.msp|packages/adobereader/AcroRdrDCUpd1700920044.msp
...
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\adobereaderdc.txt /i \"%Z%\packages\adobereader\acrordrdc1500720033_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\acrordrdcupd1700920044.msp\" REBOOT=ReallySuppress"
