...
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/AcrobatDC/2000920065/AcroRdrDCUpd2000920065.msp|packages/adobereader/AcroRdrDCUpd2000920065.msp
...
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\adobereaderdc.txt /i \"%Z%\packages\adobereader\acrordrdc1500720033_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\AcroRdrDCUpd2000920065.msp\" REBOOT=ReallySuppress"
