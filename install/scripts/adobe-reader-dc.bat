:: OPTIONAL: Install Adobe Reader Document Cloud (DC) 2300120174
@Echo Off
...
:: URL|ALL|https://ardownload2.adobe.com/pub/adobe/reader/win/AcrobatDC/2300120174/AcroRdrDCUpd2300120174.msp|packages/adobereader/acrordrdcupd2300120174.msp
...
todo.pl ".ignore-err 194 msiexec /qb /l* %SystemDrive%\netinst\logs\adobereaderdc.txt /i \"%Z%\packages\adobereader\acrordrdc1500720033_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\acrordrdcupd2300120174.msp\" REBOOT=ReallySuppress"
