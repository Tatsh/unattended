...
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/AcrobatDC/1701220095/AcroRdrDCUpd1701220095.msp|packages/adobereader/AcroRdrDCUpd1701220095.msp
...
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\adobereaderdc.txt /i \"%Z%\packages\adobereader\acrordrdc1500720033_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\acrordrdcupd1701220095.msp\" REBOOT=ReallySuppress"
