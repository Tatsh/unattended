...
::URL|ALL|http://download.gimp.org/pub/gimp/v2.10/windows/gimp-2.10.14-setup.exe|packages/gimp/gimp-2.10.14-x86-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.10.14-x86-setup.exe SP- /SILENT /NORESTART"
