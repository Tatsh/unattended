::OPTIONAL: Install GIMP (2.10.30)
::HOME: http://download.gimp.org/pub/gimp/
::URL|ALL|https://download.gimp.org/pub/gimp/v2.10/windows/gimp-2.10.30-setup.exe|packages/gimp/gimp-2.10.30-x86-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.10.30-x86-setup.exe SP- /SILENT /NORESTART"
