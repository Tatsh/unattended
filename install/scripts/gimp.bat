...
::URL|ALL|http://downloads.sourceforge.net/gimp-win/gimp-2.6.10-i686-setup-1.exe|packages/gimp/gimp-2.6.10-i686-setup.exe
...
:: Run the installers
todo.pl "start /wait %Z%\packages\gimp\gimp-2.6.10-i686-setup.exe SP- /SILENT /NORESTART"
