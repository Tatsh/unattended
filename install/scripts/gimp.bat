...
::URL|ALL|http://downloads.sourceforge.net/gimp-win/gimp-2.6.6-i686-setup.exe|packages/gimp/gimp-2.6.6-i686-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.6.6-i686-setup.exe SP- /SILENT /NORESTART"
