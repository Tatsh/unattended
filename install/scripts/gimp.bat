...
::URL|ALL|http://download.gimp.org/pub/gimp/v2.10/windows/gimp-2.10.6-setup-1.exe|packages/gimp/gimp-2.10.6-x86-setup-1.exe
...
:: Run the installers
todo.pl "start /wait %Z%\packages\gimp\gimp-2.10.6-x86-setup-1.exe SP- /SILENT /NORESTART"
