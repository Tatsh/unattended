...
::URL|ALL|http://download.gimp.org/pub/gimp/v2.10/windows/gimp-2.10.18-setup.exe|packages/gimp/gimp-2.10.18-x86-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.10.18-x86-setup.exe SP- /SILENT /NORESTART"
