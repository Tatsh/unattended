...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=27983|packages/jre/jre-6u12-windows-i586-p-s.exe
...
todo.pl "%Z%\packages\jre\jre-6u12-windows-i586-p-s.exe /s IEXPLORER=1 MOZILLA=1 REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
