...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=47363|packages/jre/jre-6u24-windows-i586-s.exe
...
todo.pl "%Z%\packages\jre\jre-6u24-windows-i586-s.exe /s IEXPLORER=1 MOZILLA=1 REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
