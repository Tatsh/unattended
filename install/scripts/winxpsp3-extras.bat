...
:: URL|ALL|http://download.microsoft.com/download/4/a/a/4aa524c6-239d-47ff-860b-5b397199cbf8/Windows-KB890830-V2.12.exe|updates/common/kb890830/windows-kb890830-v2.12.exe
todo.pl ".reboot-on 194 %Z%\updates\common\kb890830\Windows-KB890830-V2.12.exe /Q"
