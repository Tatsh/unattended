...
:: These pacthes are added last to keep the system happy
:: But they are mostly not necesary 
...
:: URL|PLK|http://download.microsoft.com/download/6/b/2/6b264546-dcec-408d-a9b3.159be4530d9d/WindowsXP-KB898461-x86-PLK.exe|updates/winxpsp2/windowsxp-kb898461-x86-plk.exe
...
:: URL|ALL|http://download.microsoft.com/download/4/A/A/4AA524C6-239D-47FF-860B-5B397199CBF8/windows-kb890830-v3.17.exe|updates/common/windows-kb890830-v3.17.exe
todo.pl ".reboot-on 194 %Z%\updates\common\Windows-KB890830-V3.17.exe /Q"
