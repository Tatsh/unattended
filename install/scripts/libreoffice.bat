...
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/5.4.3/win/x86/LibreOffice_5.4.3_Win_x86.msi|packages/libreoffice/libreoffice_5.4.3_win_x86_install.msi
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/5.4.3/win/x86_64/LibreOffice_5.4.3_Win_x64.msi|packages/libreoffice/libreoffice_5.4.3_win_AMD64_install.msi
...
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\libreoffice.txt /i %Z%\packages\libreoffice\libreoffice_5.4.3_win_%PROCESSOR_ARCHITECTURE%_install.msi /norestart /passive"
