...
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/5.4.5/win/x86/LibreOffice_5.4.5_Win_x86.msi|packages/libreoffice/libreoffice_5.4.5_win_x86_install.msi
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/5.4.5/win/x86_64/LibreOffice_5.4.5_Win_x64.msi|packages/libreoffice/libreoffice_5.4.5_win_AMD64_install.msi

@echo off

:: libreOffice 5.4.x is last one that works on windows XP
:: See bug https://bugs.documentfoundation.org/show_bug.cgi?id=112928
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\libreoffice.txt /i %Z%\packages\libreoffice\libreoffice_5.4.5_win_%PROCESSOR_ARCHITECTURE%_install.msi /norestart /passive"
