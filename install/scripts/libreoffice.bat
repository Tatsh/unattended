...
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/25.8.2/win/x86/LibreOffice_25.8.2_Win_x86.msi|packages/libreoffice/libreoffice_25.8.2_win_x86_install.msi
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/25.8.2/win/x86_64/LibreOffice_25.8.2_Win_x86-64.msi|packages/libreoffice/libreoffice_25.8.2_win_AMD64_install.msi
...
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/25.2.6/win/x86/LibreOffice_25.2.6_Win_x86.msi|packages/libreoffice/libreoffice_25.2.6_win_x86_install.msi
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/25.2.6/win/x86_64/LibreOffice_25.2.6_Win_x86-64.msi|packages/libreoffice/libreoffice_25.2.6_win_AMD64_install.msi
...
if "%WINVER%" == "win7" set VERSION=25.2.6
