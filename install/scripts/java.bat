...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=81819|packages/jre/jre-7u45-windows-i586.exe
...
todo.pl "%Z%\packages\jre\jre-7u45-windows-i586.exe /s /L %SystemDrive%\netinst\logs\jre-7u45.log REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
