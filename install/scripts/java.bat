...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=207229|packages/jre/jre-8u77-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=207231|packages/jre/jre-8u77-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u77-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u77.log REBOOT=ReallySuppress SPONSORS=0"
