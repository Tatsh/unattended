...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=116028|packages/jre/jre-8u73-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=116030|packages/jre/jre-8u73-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u73-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u73.log REBOOT=ReallySuppress SPONSORS=0"
