...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=103426|packages/jre/jre-8u40-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=103428|packages/jre/jre-8u40-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u40-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u40.log REBOOT=ReallySuppress SPONSORS=0"
