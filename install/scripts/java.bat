...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=106246|packages/jre/jre-8u45-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=106248|packages/jre/jre-8u45-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u45-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u40.log REBOOT=ReallySuppress SPONSORS=0"
