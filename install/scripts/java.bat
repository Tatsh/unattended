...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=90223|packages/jre/jre-7u60-windows-i586.exe
...
todo.pl "%Z%\packages\jre\jre-7u60-windows-i586.exe /s /L %SystemDrive%\netinst\logs\jre-7u60.log REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
