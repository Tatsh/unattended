...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=207773|packages/jre/jre-8u91-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=207775|packages/jre/jre-8u91-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u91-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u91.log REBOOT=ReallySuppress SPONSORS=0"
