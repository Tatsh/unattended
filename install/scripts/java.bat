...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=111687|packages/jre/jre-8u65-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=111689|packages/jre/jre-8u65-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u65-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u65.log REBOOT=ReallySuppress SPONSORS=0"
