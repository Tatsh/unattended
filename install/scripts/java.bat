...
::URL|ALL|http://javadl.oracle.com/webapps/download/AutoDL?BundleId=227552_e758a0de34e24606bca991d704f6dcbf|packages/jre/jre-8u151-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u151-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u151.log REBOOT=ReallySuppress SPONSORS=0"
