...
:: URL|ALL|https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs922/gs922w32.exe|packages/ghostscript/gs922-x86.exe
:: URL|ALL|https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs922/gs922w64.exe|packages/ghostscript/gs922-AMD64.exe
...
todo.pl "%Z%\packages\ghostscript\gs922-%PROCESSOR_ARCHITECTURE%.exe /S"
