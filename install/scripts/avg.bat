:: OPTIONAL: AVG Anti-Virus Free Edition 5-Sep-2014
:: HOME:http://www.avg.com/es-es/download.prd-avc
:: URL|ALL|http://download.avgfree.com/filedir/inst/avg_free_x86_all_2015_5315a8160.exe|packages/avg/avg_free_x86_all_2015_5315a8160.exe
:: URL|ALL|http://download.avgfree.com/filedir/inst/avg_free_x64_all_2015_5315a8160.exe|packages/avg/avg_free_AMD64_all_2015_5315a8160.exe
...
todo.pl "%Z%\packages\avg\avg_free_%PROCESSOR_ARCHITECTURE%_all_2015_5315a8160.exe /UILevel=Silent /InstallToolbar=0 /InstallSidebar=0 /ChangeBrowserSearchProvider=0  /DontRestart /RemoveFeatures=fea_IDP;LinkScnFea;fea_SrchSrf__Search;fea_SrchSrf__Surf;fea_OnlnSc;EmailPluginsFea;fea_Client;"
