...
:: URL|ESN|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=es&version=3.2|packages/openoffice/OOo_3.2_Win32Intel_install_esn.exe
...
:: URL|ESN|http://extensions.services.openoffice.org/files/3.2/Sun_ODF_Template_Pack_es.oxt|packages/openoffice/ext/sun-odf-template-pack-esn.oxt
...
if not exist "%Z%\packages\openoffice\OOo_3.2_Win32Intel_install_%WINLANG%.exe" goto oldversion
set ooo_install=%Z%\packages\openoffice\OOo_3.2_Win32Intel_install_%WINLANG%.exe
