...
:: Full install sets Localized Binaries for 3.1.0
:: http://wiki.services.openoffice.org/wiki/OOoRelease31

:: URL|ENU|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=en-US&version=3.1.0|packages/openoffice/OOo_3.1.0_Win32Intel_install_enu.exe
:: URL|DAN|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=da&version=3.1.0|packages/openoffice/OOo_3.1.0_Win32Intel_install_dan.exe
:: URL|DEU|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=de&version=3.1.0|packages/openoffice/OOo_3.1.0_Win32Intel_install_deu.exe
...
:: URL|FRA|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=fr&version=3.1.0|packages/openoffice/OOo_3.1.0_Win32Intel_install_fra.exe
...
:: URL|JPN|http://openoffice.bouncer.osuosl.org/?product=OpenOffice.org&os=win&lang=ja&version=3.1.0|packages/openoffice/OOo_3.1.0_Win32Intel_install_jpn.exe
...
if exist "%Z%\packages\openoffice\OOo_3.1.0_Win32Intel_install_%WINLANG%.exe" goto newversion
