:: OPTIONAL: Install TightVNC 2.8.81
:: HOME: http://www.tightvnc.com/
:: FIXME: Need to change user-agent to work
:: URL|ALL|http://www.tightvnc.com/download/2.8.81/tightvnc-2.8.81-gpl-setup-32bit.msi|packages/tightvnc-2.8.81-setup-x86.msi
:: URL|ALL|http://www.tightvnc.com/download/2.8.81/tightvnc-2.8.81-gpl-setup-64bit.msi|packages/tightvnc-2.8.81-setup-AMD64.msi
@Echo off
...
todo.pl "msiexec /qb /i %Z%\packages\tightvnc-2.8.81-setup-%PROCESSOR_ARCHITECTURE%.msi %VNC_OPTIONS%" 
