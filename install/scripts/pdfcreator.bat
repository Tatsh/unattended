...
@echo off
:: URL|ALL|http://blue.download.pdfforge.org/pdfcreator/2.2.2/PDFCreator-2_2_2-setup.exe|packages/pdfcreator/pdfcreator-2.2.2.setup.exe
...
todo.pl "%Z%\packages\pdfcreator\pdfcreator-2.2.2.setup.exe /LOG=%SystemDrive%\netinst\logs\pdfcreator.txt /SILENT /COMPONENTS=\"program\" /NORESTART"
