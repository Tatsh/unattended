...
@echo off
:: URL|ALL|http://blue.download.pdfforge.org/pdfcreator/2.3.0/PDFCreator-2_3_0-Setup.exe|packages/pdfcreator/pdfcreator-2.3.0.setup.exe
...
todo.pl "%Z%\packages\pdfcreator\pdfcreator-2.3.0.setup.exe /LOG=%SystemDrive%\netinst\logs\pdfcreator.txt /SILENT /COMPONENTS=\"program\" /NORESTART"
