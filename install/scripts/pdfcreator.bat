...
@echo off
:: URL|ALL|http://blue.download.pdfforge.org/pdfcreator/3.0.2/PDFCreator-3_0_2-Setup.exe|packages/pdfcreator/pdfcreator-3.0.2.setup.exe
...
todo.pl "%Z%\packages\pdfcreator\pdfcreator-3.0.2.setup.exe /LOG=%SystemDrive%\netinst\logs\pdfcreator.txt /SILENT /COMPONENTS=\"program\" /NORESTART"
