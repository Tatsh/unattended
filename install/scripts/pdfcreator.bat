...
@echo off
http://cdn.download.pdfforge.org/pdfcreator/1.6.0/PDFCreator-1_6_0_setup.exe
:: URL|ALL|http://cdn.download.pdfforge.org/pdfcreator/1.6.0/PDFCreator-1_6_0_setup.exe|packages/pdfcreator/pdfcreator-1.6.0.setup.exe
...
:: Install PDFCreator
todo.pl "%Z%\packages\pdfcreator\pdfcreator-1.6.0.setup.exe /SILENT /LOADINF="%Z%\packages\pdfcreator\PDFCreator.ini" /NORESTART"
