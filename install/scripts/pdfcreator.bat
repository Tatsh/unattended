:: OPTIONAL: Install PDFCreator (PDF Printer) 4.4.0
:: HOME: http://download.pdfforge.org/download/pdfcreator

@echo off
:: URL|ALL|http://cdn.download.pdfforge.org/pdfcreator/4.4.0/PDFCreator-4_4_0-Setup.exe|packages/pdfcreator/pdfcreator-4.4.0.setup.exe
