...
@echo off
:: URL|ALL|http://azure.download.pdfforge.org/pdfcreator/2.2.1/PDFCreator-2_2_1-setup.exe|packages/pdfcreator/pdfcreator-2.2.1.setup.exe
...
todo.pl "%Z%\packages\pdfcreator\pdfcreator-2.2.1.setup.exe /LOG=%SystemDrive%\netinst\logs\pdfcreator.txt /SILENT /COMPONENTS=\"program\" /NORESTART"
