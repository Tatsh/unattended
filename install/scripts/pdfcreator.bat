:: OPTIONAL: Install PDFCreator (PDF Printer) 3.5.0
:: HOME: http://download.pdfforge.org/download/pdfcreator

@echo off
:: URL|ALL|http://azure.download.pdfforge.org/pdfcreator/3.5.0/PDFCreator-3_5_0-Setup.exe|packages/pdfcreator/pdfcreator-3.5.0.setup.exe
