...
@echo off
:: URL|ALL|http://blue.download.pdfforge.org/pdfcreator/2.5.1/PDFCreator-2_5_1-Setup.exe|packages/pdfcreator/pdfcreator-2.5.1.setup.exe
...
todo.pl "%Z%\packages\pdfcreator\pdfcreator-2.5.1.setup.exe /LOG=%SystemDrive%\netinst\logs\pdfcreator.txt /SILENT /COMPONENTS=\"program\" /NORESTART"
