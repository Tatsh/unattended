:: OPTIONAL: Install PDFCreator (PDF Printer) 5.1.2
:: HOME: http://download.pdfforge.org/download/pdfcreator

@echo off
:: URL|ALL|http://cdn.download.pdfforge.org/pdfcreator/5.1.2/PDFCreator-5_1_2-Setup.exe|packages/pdfcreator/pdfcreator-5.1.2.setup.exe
