:: OPTIONAL: Install PDFCreator (PDF Printer) 4.3.0
:: HOME: http://download.pdfforge.org/download/pdfcreator

@echo off
:: URL|ALL|http://azure.download.pdfforge.org/pdfcreator/4.3.0/PDFCreator-4_3_0-Setup.exe|packages/pdfcreator/pdfcreator-4.3.0.setup.exe
