...
:: URL|All|http://downloads.sourceforge.net/inkscape/Inkscape-0.48.3.1-1.exe|packages/inkscape/inkscape-0.48.3.1-1.exe
...
todo.pl "%Z%\packages\inkscape\inkscape-0.48.3.1-1.exe /S"
