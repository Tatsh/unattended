...
:: URL|All|http://downloads.sourceforge.net/inkscape/Inkscape-0.48.0-1.exe|packages/inkscape/inkscape-0.48.0-1.win32.exe
...
todo.pl "%Z%\packages\inkscape\inkscape-0.48.0-1.win32.exe /S"
