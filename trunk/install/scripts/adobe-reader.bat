...
:: Download the patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.16/misc/AdbeRdrUpd11016.msp|packages/adobereader/adberdrupd11016.msp
:: Download security patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.15/misc/AdbeRdrSecUpd11015.msp|packages/adobereader/adberdrsecupd11015.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" PATCH=\"%Z%\packages\adobereader\adberdrupd11016.msp\" REBOOT=ReallySuppress"
