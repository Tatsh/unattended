...
:: Download the 11.04 patch
:: URL|ALL|ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.04/misc/AdbeRdrUpd11004.msp|packages/adobereader/adberdrupd11004.msp
...
todo.pl ".ignore-err 194 msiexec /qn /i \"%Z%\packages\adobereader\adberdr11000_%WINLANG%.msi\" REBOOT=ReallySuppress PATCH=\"%Z%\packages\adobereader\adberdrupd11004.msp\""
