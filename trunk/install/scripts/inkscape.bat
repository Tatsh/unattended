...
:: URL|All|http://downloads.sourceforge.net/inkscape/Inkscape-0.48.5-1-win32.exe|packages/inkscape/inkscape-0.48.5-1.exe
...
todo.pl "%Z%\packages\inkscape\inkscape-0.48.5-1.exe /S"
