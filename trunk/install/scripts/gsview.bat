...
:: URL|ALL|http://downloads.sourceforge.net/ghostscript/GPL%20Ghostscript/9.07/gs907w32.exe|packages/ghostscript/gs907w32.exe
...
todo.pl "%Z%\packages\ghostscript\gs907w32.exe /S"
