...
::URL|ALL|http://download.documentfoundation.org/libreoffice/stable/5.3.4/win/x86_64/LibreOffice_5.3.4_Win_x64.msi|packages/libreoffice/libreoffice_5.3.4_win_AMD64_install.msi
...
todo.pl ".ignore-err 194 msiexec /qn /l* %SystemDrive%\netinst\logs\libreoffice.txt /i %Z%\packages\libreoffice\libreoffice_5.3.4_win_%PROCESSOR_ARCHITECTURE%_install.msi /norestart /passive"
