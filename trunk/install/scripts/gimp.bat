...
::URL|ALL|http://download.gimp.org/pub/gimp/v2.10/windows/gimp-2.10.12-setup-3.exe|packages/gimp/gimp-2.10.12-x86-setup-3.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.10.12-x86-setup-3.exe SP- /SILENT /NORESTART"
