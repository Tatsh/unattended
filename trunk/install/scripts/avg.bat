:: OPTIONAL: AVG Anti-Virus Free Edition 07-Feb-2013
...
:: URL|ALL|http://download.avgfree.com/filedir/inst/avg_free_x86_all_2013_2899a6087.exe|packages/avg/avg_free_x86_all_2013_2899a6087.exe
:: URL|ALL|http://download.avgfree.com/filedir/inst/avg_free_x64_all_2013_2899a6087.exe|packages/avg/avg_free_AMD64_all_2013_2899a6087.exe
...
todo.pl "%Z%\packages\avg\avg_free_%PROCESSOR_ARCHITECTURE%_all_2013_2897a6066.exe /UILevel=Silent /InstallToolbar=0 /InstallSidebar=0 /ChangeBrowserSearchProvider=0  /DontRestart /RemoveFeatures=fea_IDP;LinkScnFea;fea_SrchSrf__Search;fea_SrchSrf__Surf;fea_OnlnSc;EmailPluginsFea;fea_Client;"
