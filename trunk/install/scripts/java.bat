...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=63990|packages/jre/jre-6u33-windows-i586.exe
...
todo.pl "%Z%\packages\jre\jre-6u33-windows-i586.exe /s IEXPLORER=1 MOZILLA=1 REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
