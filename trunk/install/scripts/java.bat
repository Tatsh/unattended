...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=71835|packages/jre/jre-7u10-windows-i586.exe
...
todo.pl "%Z%\packages\jre\jre-6u38-windows-i586.exe /s IEXPLORER=1 MOZILLA=1 REBOOT=ReallySuppress JAVAUPDATE=0 WEBSTARTICON=0"
