...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=211997|packages/jre/jre-8u101-windows-x86.exe
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=207775|packages/jre/jre-8u101-windows-amd64.exe
...
todo.pl "%Z%\packages\jre\jre-8u101-windows-x86.exe /s /L %SystemDrive%\netinst\logs\jre-8u101.log REBOOT=ReallySuppress SPONSORS=0"
