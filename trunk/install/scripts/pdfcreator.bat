...
:: URL|ALL|http://downloads.sourceforge.net/pdfcreator/PDFCreator-1_5_1_setup.exe|packages/pdfcreator/pdfcreator-1.5.1.setup.exe
...
:: Install PDFCreator
todo.pl "%Z%\packages\pdfcreator\pdfcreator-1.5.1.setup.exe /SILENT /LOADINF="%Z%\packages\pdfcreator\PDFCreator.ini" /NORESTART"
