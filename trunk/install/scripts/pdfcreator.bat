...
@echo off
:: URL|ALL|http://red.download.pdfforge.org/pdfcreator/1.7.0/PDFCreator-1_7_0_setup.exe|packages/pdfcreator/pdfcreator-1.7.0.setup.exe
...
:: Install PDFCreator
todo.pl "%Z%\packages\pdfcreator\pdfcreator-1.7.0.setup.exe /SILENT /LOADINF="%Z%\packages\pdfcreator\PDFCreator.ini" /NORESTART"
