...
todo.pl "%Z%\packages\win2ksp4\WindowsXP-KB824141-x86-%WINLANG%.exe /u /n /z"
...
todo.pl "%Z%\packages\win2ksp4\WindowsXP-KB825119-x86-%WINLANG%.exe /u /n /z"

:: Critical update 828035 (MS03-043)
:: "Buffer Overrun in Messenger Service Could Allow Code Execution"
:: <http://www.microsoft.com/technet/security/bulletin/MS03-043.asp>
todo.pl "%Z%\packages\win2ksp4\WindowsXP-KB828035-x86-%WINLANG%.exe /u /n /z"

:: Critical update 823182 (MS03-041)
:: "Vulnerability in Authenticode Verification Could Allow Remote Code Execution"
:: <http://www.microsoft.com/technet/security/bulletin/MS03-041.asp>
todo.pl "%Z%\packages\win2ksp4\WindowsXP-KB823182-x86-%WINLANG%.exe /u /n /z"
