...
:: Install xwinclip
todo.pl "c:\cygwin\bin\bash.exe --login -c 'cd /usr/X11R6/bin && cp /cygdrive/z/packages/xwinclip-Test06.exe.bz2 . && bunzip2 xwinclip-Test06.exe.bz2 && mv xwincip-Test06.exe xwinclip.exe'"
