...
todo.pl ".reboot-on 194 %Z%\updates\office2003\office2003-kb834691-client-%WINLANG%.exe /q /c:\"msiexec /qb /l* %SystemDrive%\netinst\logs\o2003-kb834691.txt /p excel-Binary-GLB.msp REBOOT=ReallySuppress\""
...
todo.pl ".reboot-on 194 %Z%\updates\office2003\office2003-kb835235-client-%WINLANG%.exe /q /c:\"msiexec /qb /l* %SystemDrive%\netinst\logs\o2003-kb835235.txt /p outlfltr-Binary-GLB.msp REBOOT=ReallySuppress\""
...
todo.pl ".reboot-on 194 %Z%\updates\office2003\windows-kb833407-x86-enu.exe /passive /n /norestart"
...
::todo.pl ".reboot-on 194 %Z%\updates\office2003\office2003-kb830000-client-%WINLANG%.exe /q /c:\"msiexec /qb /l* %SystemDrive%\netinst\logs\o2003-kb830000.txt /p winword-Binary-GLB.msp REBOOT=ReallySuppress\""
...
todo.pl ".reboot-on 194 %Z%\updates\office2003\office2003-kb832333-client-%WINLANG%.exe /q /c:\"msiexec /qb /l* %SystemDrive%\netinst\logs\o2003-kb832333.txt /p outlfltr-Binary-GLB.msp REBOOT=ReallySuppress\""
...
todo.pl ".reboot-on 194 %Z%\updates\office2003\office2003-kb828041-client-%WINLANG%.exe /q /c:\"msiexec /qb /l* %SystemDrive%\netinst\logs\o2003-kb828041.txt /p mso-Binary-GLB.msp REBOOT=ReallySuppress\""
