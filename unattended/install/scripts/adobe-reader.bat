...
:: Download version 7 if available; otherwise, download 6.0.2.
...
:: URL|RUS|http://ardownload.adobe.com/pub/adobe/reader/win/6.x/6.0/rus/AdbeRdr602_rus_full.exe|packages/adobereader/adberdr602_rus_full.exe
...
:: No version 7 for this language, so install 6.0.2
todo.pl "%Z%\packages\adobereader\adberdr602_%WINLANG%_full.exe -p\"-s /v\\\"/qb /l* %SystemDrive%\netinst\logs\adobe-reader.txt\\\"\""
