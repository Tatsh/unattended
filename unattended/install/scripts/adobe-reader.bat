...
:: URL|DEU|http://ardownload.adobe.com/pub/adobe/reader/win/7.x/7.0/deu/AdbeRdr70_deu_full.exe|packages/adobereader/adberdr70_deu_full.exe
:: URL|ENU|http://ardownload.adobe.com/pub/adobe/reader/win/7.x/7.0/enu/AdbeRdr70_enu_full.exe|packages/adobereader/adberdr70_enu_full.exe
:: URL|FRA|http://ardownload.adobe.com/pub/adobe/reader/win/7.x/7.0/fra/AdbeRdr70_fra_full.exe|packages/adobereader/adberdr70_fra_full.exe
...
:: URL|JPN|http://ardownload.adobe.com/pub/adobe/reader/win/7.x/7.0/jpn/AdbeRdr70_jpn_full.exe|packages/adobereader/adberdr70_jpn_full.exe
