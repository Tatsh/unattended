...
:: URL|ALL|http://jdl.sun.com/webapps/download/AutoDL?BundleId=9934|packages/jre1.5.0_01.msi
...
@Echo off
todo.pl "msiexec /qb /l* %SystemDrive%\netinst\logs\sun-jre.txt /i %Z%\packages\jre1.5.0_01.msi IEXPLORER=1 MOZILLA=1 NETSCAPE6=1 REBOOT=ReallySuppress JAVAUPDATE=0"
