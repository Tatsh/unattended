...
::URL|ALL|http://javadl.sun.com/webapps/download/AutoDL?BundleId=12777|packages/jre/jre1.6.0_3.msi

@Echo off
todo.pl ".reboot-on 194 msiexec /qb /l* %SystemDrive%\netinst\logs\sun-jre.txt /i %Z%\packages\jre\jre1.6.0_3.msi IEXPLORER=1 MOZILLA=1 REBOOT=Suppress JAVAUPDATE=0"
