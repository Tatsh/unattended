...
:: URL|ALL|http://jdl.sun.com/webapps/download/AutoDL?BundleId=10550|packages/jre/jre1.5.0_07.msi

@Echo off
todo.pl ".reboot-on 194 msiexec /qb /l* %SystemDrive%\netinst\logs\sun-jre.txt /i %Z%\packages\jre\jre1.5.0_07.msi IEXPLORER=1 MOZILLA=1 REBOOT=Suppress JAVAUPDATE=0"
