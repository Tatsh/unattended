...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB824141-x86-%WINLANG%.exe /u /n /z" .reboot
...
todo.pl "%Z%\updates\winxpsp1\WindowsXP-KB825119-x86-%WINLANG%.exe /u /n /z"

:: Critical update 828035 (MS03-043)
:: "Buffer Overrun in Messenger Service Could Allow Code Execution"
:: <http://www.microsoft.com/technet/security/bulletin/MS03-043.asp>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB828035-x86-%WINLANG%.exe /u /n /z" .reboot

:: Critical update 823182 (MS03-041)
:: "Vulnerability in Authenticode Verification Could Allow Remote Code Execution"
:: <http://www.microsoft.com/technet/security/bulletin/MS03-041.asp>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB823182-x86-%WINLANG%.exe /u /n /z" .reboot

:: Recommended update 822603
:: "Windows XP SP1 USB 1.1 and 2.0 Update"
:: <http://support.microsoft.com/?kbid=822603>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB822603-x86-%WINLANG%.exe /u /n /z" .reboot

:: Critical update 824146
:: "A Buffer Overrun in RPCSS May Allow Code Execution"
:: (Worst Windows security hole, ever.  Again.)
:: <http://support.microsoft.com/?kbid=824146>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB824146-x86-%WINLANG%.exe /u /n /z" .reboot

:: Critical update 824105
:: "Flaw in NetBIOS Could Lead to Information Disclosure"
:: <http://support.microsoft.com/?kbid=824105>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB824105-x86-%WINLANG%.exe /u /n /z" .reboot
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q823718_MDAC_SecurityPatch.exe /q /c:\"dahotfix.exe /q /n\"" .reboot

:: Recommended update 817778
:: "Advanced Networking Pack for Windows XP"
:: <http://support.microsoft.com/?kbid=817778>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB817778-x86-%WINLANG%.exe /u /n /z" .reboot
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB821557-x86-%WINLANG%.exe /u /n /z" .reboot

:: Windows Journal Viewer update
:: <http://download.windowsupdate.com/msdownload/update/v3/static/rtf/en/5850.htm>
todo.pl "%Z%\updates\winxpsp1\journal_viewer_%WINLANG%.exe /q /c:\"msiexec /i \"\"Microsoft Windows Journal Viewer.msi\"\" /qn\""

:: Recommended update 821253
:: "Update For Windows Error Reporting"
:: <http://support.microsoft.com/?kbid=821253>
todo.pl "%Z%\updates\winxpsp1\WindowsXP-KB821253-x86-%WINLANG%.exe /u /n /z"

:: Critical update 817606
:: "Buffer Overrun in Windows Could Lead to Data Corruption"
:: <http://support.microsoft.com/?kbid=817606>
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q817606_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot
...
todo.pl "%Z%\updates\winxpsp1\WindowsXP-KB823559-x86-%WINLANG%.exe /u /n /z"
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\WindowsXP-KB820291-x86-%WINLANG%.exe /u /n /z" .reboot

:: "Update for Windows Media Player Script Commands"
:: <http://support.microsoft.com/?kbid=828026>
todo.pl "%Z%\updates\winxpsp1\WindowsMedia-KB828026-x86-%WINLANG%.exe /passive /n /norestart"
...
todo.pl "%Z%\updates\winxpsp1\WindowsMedia9-KB819639-x86-%WINLANG%.exe /Q /R:N" .reboot
...
todo.pl "%Z%\updates\winxpsp1\MPSetupXP.EXE /Q /R:N /C:\"setup_wm.exe /DisallowSystemRestore /NoPID /SetWMPAsDefault /Q /R:N\""
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q815021_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\js56n%WINLANG%.exe /q /r:n" .reboot
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q814033_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot
...
todo.pl "%Z%\updates\winxpsp1\Q811630_WXP_SP2_x86_%WINLANG%.exe /u /n /z"
...
todo.pl "%Z%\updates\winxpsp1\Q810833_WXP_SP2_x86_%WINLANG%.exe /u /n /z"
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q810577_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q810565_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot
...
todo.pl "%Z%\updates\winxpsp1\Q329834_WXP_SP2_x86_%WINLANG%.exe /u /n /z"

:: Critical update 329441
:: "You Cannot Create a Network Connection After You Restore Windows XP"
:: <http://support.microsoft.com/?kbid=329441>
:: (download only available from Windows Update Catalog)
todo.pl "%Z%\updates\winxpsp1\Q329441_WXP_SP2_en.exe /u /n /z"
...
todo.pl "%Z%\updates\winxpsp1\Q329048_WXP_SP2_x86_%WINLANG%.exe /u /n /z"
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\Q328310_WXP_SP2_x86_%WINLANG%.exe /u /n /z" .reboot

:: Recommended update 327979
:: "Game Stops Responding (Hangs) or Quits Unexpectedly ..."
:: <http://support.microsoft.com/?kbid=327979>
:: (download only available from Windows Catalog)
todo.pl "%Z%\updates\winxpsp1\Q327979_WXP_SP2_x86_%WINLANG%.exe /u /n /z"
...
todo.pl "%Z%\updates\winxpsp1\Q327696_WXP_SP2_x86_%WINLANG%.exe /u /n /z"
...
:: (only available from Windows Update Catalog)
todo.pl "%Z%\updates\winxpsp1\hu1002_pro.exe /q"
...
todo.pl "%Z%\updates\winxpsp1\Q323255_WXP_SP2_x86_%WINLANG%.exe /u /n /z"

:: Recommended update 322011
:: "You Cannot Preview a Fax in the Fax Console"
:: <http://support.microsoft.com/?kbid=322011>
todo.pl "%Z%\updates\winxpsp1\Q322011_WXP_SP2_x86_%WINLANG%.exe /u /n /z"

:: Microsoft .NET framework
:: <http://msdn.microsoft.com/netframework/downloads/>
todo.pl "%Z%\updates\winxpsp1\dotnetfx.exe /q /c:\"install /q\""
...
todo.pl ".ignore-err 194 %Z%\updates\winxpsp1\vbs56n%WINLANG%.exe /q /r:n" .reboot
