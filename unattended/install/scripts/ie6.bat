...
todo.pl ".ignore-err 194 %Z%\packages\ie6sp1\updates\q828750.exe /q /r:n" .reboot
...
todo.pl ".ignore-err 194 %Z%\packages\ie6sp1\updates\q330994.exe /q /r:n" .reboot
...
todo.pl "%Z%\packages\ie6sp1\updates\Q318203_MSXML30_x86.exe /q:a /c:\"dahotfix /q /n\"" .reboot

todo.pl ".ignore-err 194 %Z%\packages\ie6sp1\IE6setup.exe /q /r:n" .reboot
