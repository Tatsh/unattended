...
:: Install PDFCreator
:: URL|ALL|http://dl.sourceforge.net/sourceforge/pdfcreator/PDFCreator-0_8_1_GPLGhostscript.exe|packages/pdfcreator/pdfcreator-0_8_1_rc8_gplghostscript.exe
todo.pl "%Z%\packages\pdfcreator\pdfcreator-0_8_1_rc8_gplghostscript.exe /sp- /silent /norestart"
