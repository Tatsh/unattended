...
:: URL|ALL|http://mirror.cs.wisc.edu/pub/mirrors/ghost/GPL/gs862/gs862w32.exe|packages/ghostscript/gs862w32.exe
...
todo.pl "\"%ProgramFiles%\7-Zip\7z\" x -o\"%TEMP%\"\gs %Z%\packages\ghostscript\gs862w32.exe"
