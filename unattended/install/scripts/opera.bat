...
:: URL|ALL|http://get.opera.com/pub/opera/win/910/int/Opera_9.10_International_Setup.exe|packages/opera/opera-910-int.exe
@Echo off

:: if you like to do special things (e.g. define custom searches), save your customized ini's in packages/opera/special

%Z%\packages\opera\opera-910-int.exe /S /v/qn
