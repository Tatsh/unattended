...
:: URL|DEU|http://sunsite.informatik.rwth-aachen.de/ftp/pub/mirror/OpenOffice/localized/de/1.1.0/OOo_1.1.0_Win32Intel_install_de.zip|packages/openoffice/ooo_1.1.0_win32intel_install_deu.zip
