...
:: URL|ALL|http://downloads.activestate.com/ActivePerl/Windows/5.8/ActivePerl-5.8.7.815-MSWin32-x86-211909.msi|packages/activeperl-5.8.7.815-mswin32-x86-211909.msi
set perl_msi=%Z%\packages\activeperl-5.8.7.815-mswin32-x86-211909.msi
