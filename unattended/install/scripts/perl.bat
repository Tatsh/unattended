...
:: URL|ALL|http://downloads.activestate.com/ActivePerl/Windows/5.10/ActivePerl-5.10.0.1003-MSWin32-x86-283697.msi|packages/perl/activeperl-5.10.0.1003-mswin32-x86-283697.msi
set perl_msi=%Z%\packages\perl\activeperl-5.10.0.1003-mswin32-x86-283697.msi
