...
:: URL|ALL|http://downloads.activestate.com/ActivePerl/Windows/5.8/ActivePerl-5.8.1.807-MSWin32-x86.msi|packages/activeperl-5.8.1.807-mswin32-x86.msi
start /wait msiexec /qb /l* c:\netinst\logs\perl.txt /i %Z%\packages\ActivePerl-5.8.1.807-MSWin32-x86.msi PERL_PATH=Yes PERL_EXT=Yes
