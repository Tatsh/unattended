...
::URL|ALL|http://dl.sourceforge.net/sourceforge/gimp-win/gimp-2.4.0-i586-setup.exe|packages/gimp/gimp-2.4.0-i586-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.4.0-i586-setup.exe SP- /SILENT /NORESTART"
