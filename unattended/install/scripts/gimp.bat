...
::URL|ALL|http://downloads.sourceforge.net/gimp-win/gimp-2.6.0-i686-setup-1.exe|packages/gimp/gimp-2.6.0-i686-setup-1.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.6.0-i686-setup-1.exe SP- /SILENT /NORESTART"
