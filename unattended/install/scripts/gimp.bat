::OPTIONAL: Install GIMP (2.4.7)
::HOME: http://gimp-win.sourceforge.net/
::URL|ALL|http://downloads.sourceforge.net/gimp-win/gimp-2.4.7-i686-setup.exe|packages/gimp/gimp-2.4.7-i686-setup.exe
...
todo.pl "start /wait %Z%\packages\gimp\gimp-2.4.7-i686-setup.exe SP- /SILENT /NORESTART"
