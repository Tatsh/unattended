...
:: URL|ALL|http://download.nullsoft.com/winamp/client/winamp508_full.exe|packages/winamp/winamp508-full.exe
todo.pl "%Z%\packages\winamp\winamp508-full.exe /S /install=SFQR"
