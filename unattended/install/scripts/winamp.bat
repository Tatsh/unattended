...
:: URL|ALL|http://download.nullsoft.com/winamp/client/winamp509_full_emusic-8basic.exe|packages/winamp/winamp509-full.exe
todo.pl "%Z%\packages\winamp\winamp509-full.exe /S /install=SFQR"
