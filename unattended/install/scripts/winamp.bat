...
:: URL|ALL|http://download.nullsoft.com/winamp/client/winamp507_full.exe|packages/winamp/winamp507-full.exe
todo.pl "%Z%\packages\winamp\winamp507-full.exe /S /install=SFQR"
