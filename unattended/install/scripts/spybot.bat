...
:: URL|ALL|http://fileforum.betanews.com/sendfile/1043809773/1/spybotsd14.exe|packages/spybotsd/spybotsd14.exe
@Echo off
...
todo.pl "%Z%\packages\spybotsd\spybotsd14.exe /sp- /silent /norestart"
