...
:: URL|ALL|http://www.spybotupdates.com/updates/files/spybotsd_includes.exe|packages/spybotsd/spybotsd_includes-090204.exe
...
todo.pl "%Z%\packages\spybotsd\spybotsd_includes-090204.exe /S /D=\"%ProgramFiles%\Spybot~1\"
